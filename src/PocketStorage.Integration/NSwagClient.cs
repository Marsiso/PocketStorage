...
namespace PocketStorage.Integration
{
    ...
    public partial class NSwagClient
    {
        ...
        /// <exception cref="ApiCallException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiCallResponseWrapper<ApiCallResponseOfUserInfo>> ApiUserinfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiCallResponseOfUserInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiCallException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            return new ApiCallResponseWrapper<ApiCallResponseOfUserInfo>(status_, headers_, objectResponse_.Object);
                        }
                        else
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiCallException<ApiCallResponseOfUserInfo>("A server side error occurred.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
    ...
    public partial class ApiCallResponseOfUserInfo
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ApiCallError
    {
        [Newtonsoft.Json.JsonProperty("status", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public RequestStatus Status { get; set; }
